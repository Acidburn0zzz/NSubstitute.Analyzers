...
namespace NSubstitute.Analyzers.Tests.VisualBasic.DiagnosticAnalyzersTests.AwaitedWhenCallAnalyzerTests
{
    ...
    public class WhenAsOrdinaryMethodTests : AwaitedWhenCallAnalyzerVerifier
    {
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            {method}(substitute, [|Async Function(callInfo) Await callInfo.Bar()|])
        End Sub
    End Class
End Namespace";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            {method}(substitute, Function(callInfo) callInfo.Bar())
        End Sub
    End Class
End Namespace";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            {method}(substitute, Async Function(callInfo) Await callInfo.Bar(), 1)
        End Sub
    End Class
